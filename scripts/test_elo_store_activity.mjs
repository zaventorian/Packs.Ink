...
// Index.html has mixed line endings (core.autocrlf=true rewrites merged
// regions CRLF); the LF-based extraction markers below need a normalized
// source. Same fix as test_proxy_pdf.mjs; runtime behavior is unaffected.
