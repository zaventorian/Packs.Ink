...
// whether it bites at all depends on which column the Locations land in, which
// is why it read as "not sure if it's just me".
//
...
//
// A cover-fit, crop-to-match-neighbours version of the landscape cell was
// tried 2026-09-18 (a taller 5/7 footprint, image overscaled to 140% and
// clipped) and reverted the same day: the user wanted the card fully visible,
// uncropped, "as if you turned the real card horizontal" -- a shorter cell
// (and the resulting gap versus its portrait neighbours) is the accepted
// tradeoff, cropping the card is not. Guard against that regressing too.
//
...
// wrapper's edges — EXACT fit, no cropping.
